I use Neovim or Nvim to unfrecuenly edit configurations in the terminal in addition to Nvim i use the [[NvChad (NeoVim Configuration)]] as base configuration of my NeoVim Instalation Setup. 
